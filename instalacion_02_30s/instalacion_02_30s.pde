...
void draw() {
 ...
 // tint(255, 50);
  ...
  for (int i =0; i < faces.length; i++) {
    rect(map(faces[i].x,0,640,0,1920)+10, map(faces[i].y,0,480,0,1080)+10, faces[i].width+20, faces[i].height+20);
  }
  ...
  if (millis() > 9000) {
  textSize(35);
  text("cubrite los ojos durante " + str(30-(int)barra) + " segundos", 700, 1050);
  }
  if (barra > 30) {
    barra =0;
   // gg = true;
